...
describe('Incremendator Component', () => {
    ...
    it('Debe de mostrar la leyenda', () => {
        ...
        //depurar un elemento query es buscar un elemento y qyeryAll  es bucar todo los elementos, 
        //queryAllNodes es buscar todos los nodos que coincida en el parametro colocado
